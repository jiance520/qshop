...
<section>
    <div class="container">
        ...
        <div class="row n1">
            <form class="form-inline f1" action="register" method="post">
                <div class="row hh1">
                ...
                <div class="row hh1">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" style="width: 280px;" type="text" name="name" placeholder="请输入昵称"/>
                    </div>
                </div>
                <div class="row hh1">
                    <div class="col-md-2 ">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" style="width: 280px;" type="password" name="password" placeholder="请输入密码"/>
                    </div>
                </div>
                <div class="row hh1">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" style="width: 280px;" type="text" name="address" placeholder="请输入地址"/>
                    </div>
                </div>
                <div class="row hh1">
                    <div class="col-md-2">
                ...
                <div class="row hh2">
                    <div class="col-md-12 text-center">
                        <input type="submit" id="my_button" class="btn btn-default" style="background-color: #EFEFEF;width: 100px;" value="注册"/>
                    </div>
                </div>
            </form>
        </div>
...
<script type="text/javascript">
    ...
    $("#uname").blur(function(){
        var uname = $(this).val();
        //alert(uname);
        $.post('nameCheck',{names:uname},function(data){
            //alert(data);
            if(data=="true"){
                $("#dd").html('*用户已注册');
            }
